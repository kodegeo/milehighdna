  ...
  return (
    <main>
      <Helmet>
        ...
        <meta
          name="description"
          content="Mile High DNA Testing provides legal paternity and immigration DNA testing in Denver, Aurora, Lakewood, and throughout Colorado. Legal and immigration testing through an AABB accredited laboratory we partner with. Fast, confidential service."
        />
        ...
        <meta property="og:description" content="Learn more about Mile High DNA Testing — professional DNA collection and case coordination in Colorado. Legal and immigration testing through an AABB accredited laboratory we partner with." />
