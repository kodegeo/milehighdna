...
const PaternityTestColorado = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "Colorado family courts, child support enforcement agencies, and immigration authorities (USCIS) accept legal paternity test results from AABB accredited laboratory when proper chain of custody procedures are followed. Non-legal test results are not accepted by any government agency."
    }
  ];
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mt-12 bg-white rounded-xl p-6 border border-gray-200">
            ...
            <p className="text-gray-600 mb-3">
              Some immigration and visa applications require DNA testing to verify a biological parent-child relationship. These tests must follow strict chain-of-custody procedures and be performed at AABB accredited laboratory to meet USCIS and embassy requirements.
            </p>
