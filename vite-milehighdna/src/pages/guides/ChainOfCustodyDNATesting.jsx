    ...
    <GuideLayout
      ...
      process={
        <>
          ...
          <p className="text-lg text-gray-600 mb-6">
            Any break in the chain or failure to verify identity can compromise admissibility. For accreditation standards that support this process, read <Link to="/guides/accredited-laboratories-immigration-dna-testing" className="text-blue-600 underline">AABB accredited laboratory requirements for immigration DNA tests</Link>.
          </p>
        </>
      }
      legal={
