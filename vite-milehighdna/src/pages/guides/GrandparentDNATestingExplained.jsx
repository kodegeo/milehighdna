...
const faqs = [
  ...
  },
  {
    ...
    answer: "Yes, if the test is performed as a legal test with identity verification, chain-of-custody, and an AABB-accredited partner laboratory. Results can then be submitted to the court. Peace-of-mind grandparent tests are not admissible."
  },
  {
