  ...
  return (
    <GuideLayout
      ...
      process={
        <>
          <p className="text-lg text-gray-600 mb-6 leading-relaxed">
            The laboratory determines the best approach: testing the deceased's sample (if available and suitable) or testing living relatives (e.g., child and grandparents, or child and siblings). For legal tests, living participants are identified and chain-of-custody is followed. Samples are analyzed by an AABB accredited laboratory, which reports the probability of the relationship. Complex samples (e.g., from personal effects) may require additional extraction and validation.
          </p>
          <p className="text-lg text-gray-600 mb-6">
