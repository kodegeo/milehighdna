...
const faqs = [
  ...
  },
  {
    ...
    answer: "Yes, if the test is performed as a legal test with identity verification (of living participants), chain-of-custody, and an accredited partner laboratory. Results can be used in probate, inheritance, and other court cases when the court accepts postmortem kinship testing."
  },
  {
  ...
  return (
    <GuideLayout
      ...
      process={
        <>
          <p className="text-lg text-gray-600 mb-6 leading-relaxed">
            The laboratory determines the best approach: testing the deceased's sample (if available and suitable) or testing living relatives (e.g., child and grandparents, or child and siblings). For legal tests, living participants are identified and chain-of-custody is followed. Samples are analyzed by an accredited partner laboratory, which reports the probability of the relationship. Complex samples (e.g., from personal effects) may require additional extraction and validation.
          </p>
          <p className="text-lg text-gray-600 mb-6">
      ...
      legal={
        <>
          <p className="text-lg text-gray-600 mb-6 leading-relaxed">
            Postmortem DNA tests can be performed as legal tests (for court, probate, or agency use) or as peace-of-mind tests for personal use only. Legal tests require identity verification of living participants, chain-of-custody, and accredited partner laboratory analysis. If you might need results for probate or court, choose a legal test from the start.
          </p>
          <p className="text-lg text-gray-600 mb-6">
