  ...
  const categories = [
    ...
    },
    {
      ...
      guides: [
        ...
        { title: "Accredited Partner Laboratories For Immigration DNA Tests", description: "Why immigration DNA tests must use AABB-accredited partner laboratory. USCIS and embassy requirements. Denver immigration DNA testing.", link: "/guides/aabb-labs-for-immigration" },
