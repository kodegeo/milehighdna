  ...
  return (
    <GuideLayout
      ...
      legal={
        <>
          <p className="text-lg text-gray-600 mb-6 leading-relaxed">
            Legal DNA tests follow the same laboratory timeline; the extra time is usually for identity verification, chain-of-custody documentation, and certified reporting. Courts and agencies accept results when the test is performed by an AABB accredited laboratory with proper procedures.
          </p>
          <p className="text-lg text-gray-600 mb-6">
