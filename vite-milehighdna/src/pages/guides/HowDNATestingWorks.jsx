  ...
  return (
    <GuideLayout
      ...
      legal={
        <>
          <p className="text-lg text-gray-600 mb-6 leading-relaxed">
            Legal DNA testing follows documented chain-of-custody: verified ID, certified collection, and analysis by an AABB-accredited partner laboratory. Results are admissible in court and for USCIS. Non-legal (peace-of-mind) testing does not include these steps and is for personal information only.
          </p>
          <p className="text-lg text-gray-600 mb-6">
