  ...
  return (
    <GuideLayout
      ...
      legal={
        <>
          <p className="text-lg text-gray-600 mb-6 leading-relaxed">
            Legal DNA testing is designed for court and agency use. It requires verified identification, chain-of-custody procedures, and analysis by an AABB-accredited partner laboratory. The same high accuracy applies, with the added assurance that results will be accepted as evidence.
          </p>
          <p className="text-lg text-gray-600 mb-6">
