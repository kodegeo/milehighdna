...
const faqs = [
  ...
  },
  {
    ...
    answer: "Yes, if the test is performed as a legal test with identity verification, chain-of-custody, and an AABB-accredited partner laboratory. Results can then be submitted to the court or, when accepted, to immigration authorities. Peace-of-mind avuncular tests are not admissible."
  },
  {
