            ...
            },
            {
              ...
              "mainEntity": [
                ...
                },
                {
                  ...
                  "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "Yes, non-legal DNA tests provide the same scientific accuracy as legal tests when processed by accredited partner laboratory. The difference is in collection method and documentation, not accuracy."
                  }
                },
                {
                  "@type": "Question",
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-600">
                Yes, non-legal DNA tests provide the same scientific accuracy as legal tests when processed by accredited partner laboratory. The difference is in collection method and documentation, not accuracy.
              </p>
            </div>
