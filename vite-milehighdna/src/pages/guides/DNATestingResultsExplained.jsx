...
const faqs = [
  ...
  },
  {
    ...
    answer: "Only if the test was performed as a legal test with chain-of-custody, identity verification, and analysis by an accredited partner laboratory. Peace-of-mind or at-home test results are not admissible in court."
  },
  {
  ...
  return (
    <GuideLayout
      ...
      legal={
        <>
          <p className="text-lg text-gray-600 mb-6 leading-relaxed">
            Legal DNA test results are accompanied by chain-of-custody documentation and are issued by an accredited partner laboratory. They can be sent directly to courts, attorneys, or government agencies when authorized. Non-legal test results are for personal use only and are not admissible.
          </p>
          <p className="text-lg text-gray-600 mb-6">
