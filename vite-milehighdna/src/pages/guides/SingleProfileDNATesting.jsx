...
const faqs = [
  ...
  },
  {
    ...
    answer: "Yes, if the single profile was created under legal chain-of-custody procedures (identity verification, certified collection, AABB-accredited partner laboratory). When the second party is tested later, the lab can perform a comparison using the stored profile and issue a legal report."
  },
  {
  ...
  return (
    <GuideLayout
      ...
      legal={
        <>
          <p className="text-lg text-gray-600 mb-6 leading-relaxed">
            Single profile tests can be legal (with identity verification, chain-of-custody, and AABB-accredited partner laboratory) or peace-of-mind (for personal use only). If you might need a future comparison for court or immigration, the single profile must be created as a legal test from the start—peace-of-mind profiles cannot be converted to legal later.
          </p>
          <p className="text-lg text-gray-600 mb-6">
