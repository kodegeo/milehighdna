...
const faqs = [
  {
    question: "Why does immigration DNA testing require AABB accredited laboratory processing?",
    answer: "USCIS and U.S. embassies require relationship DNA testing to be performed by an AABB accredited laboratory to ensure consistent scientific standards, validation, and documentation. Results from non-AABB labs are typically not accepted for immigration purposes."
  },
  {
    question: "What is AABB laboratory accreditation?",
  ...
  {
    question: "How do I find an AABB accredited laboratory for immigration DNA testing?",
    answer: "DNA testing facilities like Mile High DNA Testing in Denver work with an AABB accredited laboratory and coordinate the full process—collection, chain-of-custody, and reporting—so your results meet immigration requirements."
  }
];
...
export default function AABBLabsForImmigration() {
  return (
    <GuideLayout
      ...
      ctaSubline="Immigration cases must be initiated by an AABB accredited laboratory. We coordinate local sample collection in Denver when directed."
    />
  );
}
