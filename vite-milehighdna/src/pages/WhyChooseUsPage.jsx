  ...
  return (
    <main>
      <Helmet>
        ...
        <meta
          name="description"
          content="Mile High DNA Testing provides court-admissible and immigration DNA testing with an AABB accredited laboratory, chain-of-custody procedures, and direct professional support in Denver and Colorado."
        />
        ...
        <meta property="og:description" content="Court-admissible and immigration DNA testing through an AABB accredited laboratory we partner with, with direct professional support in Denver, Colorado." />
      ...
      <section className="py-12 md:py-14 px-4 md:px-8 bg-white">
        <div className="max-w-5xl mx-auto">
          ...
          />
          <p className="text-gray-700 leading-relaxed mb-4">
            All DNA testing is performed by an AABB accredited laboratory that meets established scientific and documentation standards.
          </p>
          <p className="text-gray-700 leading-relaxed mb-4">
