  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="A Denver father sought peace of mind through paternity testing. Learn how accurate, confidential DNA testing provides clarity when appearances raise questions."
        />
      ...
      <CornerLayout>
        ...
        <div className="w-full px-4 md:px-0 py-8 bg-white/90 rounded-xl shadow-lg">
          ...
          <p className="text-base mb-6 text-justify">
            ...
            we assured him that an AABB accredited laboratory we partner with would
