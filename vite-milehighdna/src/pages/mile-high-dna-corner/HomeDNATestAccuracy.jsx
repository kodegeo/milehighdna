    ...
    <>
      ...
      <Helmet>
        ...
        <meta
          ...
          content="Explore the accuracy of at-home DNA tests and how they compare with legal and immigration DNA testing through an AABB accredited laboratory we partner with."
        />
        <meta
          property="og:image"
        ...
        <script type="application/ld+json">{`
        {
          ...
          "description": "A detailed look at the accuracy of at-home DNA tests compared to legal and immigration DNA testing through an AABB accredited laboratory we partner with.",
      ...
      <CornerLayout>
        ...
        <div className="w-full px-4 md:px-0 py-8 bg-white/90 rounded-xl shadow-lg">
          ...
          <p className="text-base mb-6 text-justify">
          By contrast, paternity and family relationship tests for court or immigration must be processed through an AABB accredited laboratory.
          This distinction matters — CLIA certification ensures lab quality, while AABB accredited laboratory standards support legal and immigration admissibility.
          {" "}{AABB_HOME_KIT_DISCLAIMER}
          </p>
          ...
          legal testing coordinated through an AABB accredited laboratory we partner with includes all fees upfront — from collection to reporting — with clear, transparent pricing and court-admissible results.
          </p>

          <h3 className="text-2xl font-bold mt-10 mb-4 text-gray-800">Partner with an AABB Accredited Laboratory</h3>
          <p className="text-base mb-6 text-justify">
          ...
          <p className="text-base mb-6 text-justify">
          This level of oversight ensures that AABB accredited laboratory testing produces results that are legally defensible and accepted by
          ...
          U.S. Citizenship and Immigration Services (USCIS)</a> confirms that immigration DNA cases require chain-of-custody and AABB accredited laboratory processing.
          </p>
          ...
          AABB accredited laboratory, even when used for informational purposes. This means you can collect your sample at home while
