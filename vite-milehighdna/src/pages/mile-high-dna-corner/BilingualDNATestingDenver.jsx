        ...
        <script type="application/ld+json">{`
        {
          ...
          "mainEntity": [
            ...
            },
            {
              ...
              "acceptedAnswer": {
                "@type": "Answer",
                "text": "Yes. We coordinate immigration DNA testing through an AABB accredited laboratory we partner with."
              }
            },
            {
              "@type": "Question",
      ...
      <CornerLayout>
        ...
        <div className="w-full px-4 md:px-0 py-8 bg-white/90 rounded-xl shadow-lg max-w-4xl mx-auto">
          ...
          <ul className="list-disc ml-6 mb-6 space-y-2 text-base">
            ...
            <li>Support for legal and immigration DNA tests through an AABB accredited laboratory we partner with</li>
          ...
          <ul className="list-disc ml-6 mb-6 space-y-2 text-base">
            ...
            <li>AABB accredited laboratory for court and immigration standards</li>
