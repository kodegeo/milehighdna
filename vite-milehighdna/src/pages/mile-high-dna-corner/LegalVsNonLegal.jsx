    ...
    <>
      ...
      <CornerLayout>
        ...
        <div className="w-full px-4 md:px-0 py-8 bg-white/90 rounded-xl shadow-lg">
          ...
          As the U.S. Citizenship and Immigration Services (USCIS) explains, immigration DNA cases require chain-of-custody and AABB accredited laboratory processing. <br /><br /> 
          ...
          <p className="text-base mb-6 text-justify">
          <span className="font-bold text-[#2C6FA6]">Mile High DNA Testing</span> provides both legal and non-legal DNA testing services for families across Denver, Aurora, Thornton, and Lakewood. Legal and immigration testing is provided through an AABB accredited laboratory we partner with, and non-legal testing is processed with validated partner laboratory methods. <br /><br />
