...
const NON_LEGAL_IN_OFFICE_FAQS = [
  ...
  },
  {
    ...
    answerSchema:
      "Yes. International kit shipments can be coordinated. Shipping timelines and customs regulations vary by country. All testing is performed by an accredited partner laboratory in accordance with established DNA testing standards.",
    answer: (
      <>
        <p>
        ...
        <p>
          All testing is performed by an accredited partner laboratory in accordance with established DNA testing standards.
        </p>
      </>
    ),
  },
        ...
        <div className="container mx-auto px-6 py-16 flex flex-col lg:flex-row items-center gap-12">
          <div className="flex-1 text-center lg:text-left">
            ...
            <p className="text-gray-700 mb-8 text-lg leading-relaxed">
              ...
              non-legal DNA results performed by accredited partner laboratory. 
