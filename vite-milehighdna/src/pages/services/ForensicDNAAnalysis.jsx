  ...
  return (
    <main className="min-h-screen bg-gray-50">
      <Helmet>
        ...
        <meta
          name="description"
          content="Expert forensic DNA analysis in Denver for legal cases, missing persons, and complex relationship verification. Court-admissible testing through an AABB accredited laboratory."
        />
        <meta
          name="keywords"
        ...
        <meta property="og:description" content="Expert forensic DNA analysis for legal cases, missing persons, and complex relationship verification. Court-admissible testing through an AABB accredited laboratory." />
          ...
          {JSON.stringify({
            ...
            "mainEntity": [
              ...
              },
              {
                ...
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "Yes. All forensic DNA analysis follows strict chain-of-custody procedures and is performed by an AABB accredited laboratory, ensuring results are court-admissible and suitable for legal proceedings."
                }
              },
              {
                "@type": "Question",
        ...
        <div className="container mx-auto px-6 py-16 flex flex-col lg:flex-row items-center gap-12">
          <div className="flex-1 text-center lg:text-left">
            ...
            <p className="text-gray-700 mb-8 text-lg leading-relaxed">
              ...
              AABB accredited laboratory with strict chain-of-custody procedures, our forensic 
      ...
      <section className="bg-gray-50 py-16">
        <div className="container mx-auto px-6 max-w-5xl">
          ...
          <ul className="grid md:grid-cols-2 gap-6 text-gray-700 text-lg">
            <li>✅ Partner with an AABB Accredited Laboratory — Processing for legal and immigration case requirements</li>
        ...
        <div className="container mx-auto px-6 max-w-4xl">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white p-6 rounded-lg shadow">
              ...
              <p className="text-gray-600">Yes. All forensic DNA analysis follows strict chain-of-custody procedures and is performed by an AABB accredited laboratory, ensuring results are court-admissible and suitable for legal proceedings.</p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow">
