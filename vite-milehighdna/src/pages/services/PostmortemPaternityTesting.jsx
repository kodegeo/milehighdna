...
const PostmortemPaternityTesting = () => {
  ...
  const processSteps = [
    ...
    { step: 4, title: "Laboratory Analysis", description: "Testing is performed through an AABB accredited laboratory. Legal cases undergo multi-level technical review before release." },
      ...
      <section className="py-12 md:py-16 px-6 bg-white">
        <div className="max-w-4xl mx-auto">
          <p className="text-lg text-gray-700 leading-relaxed mb-6">
            We coordinate <Link to="/partner-laboratory-denver" className="text-blue-600 hover:underline">AABB accredited laboratory legal DNA testing standards</Link> for postmortem cases and work with families who need <Link to="/services/legal-paternity-testing" className="text-blue-600 hover:underline">legal paternity DNA testing</Link> or <Link to="/services/immigration-dna-testing" className="text-blue-600 hover:underline">immigration DNA testing</Link> in other situations. Mile High DNA Testing provides structured postmortem DNA testing in Denver for:
          </p>
