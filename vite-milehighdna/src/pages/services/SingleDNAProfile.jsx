    ...
    <main>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6 mb-6">
            ...
            <div>
              ...
              <p className="text-gray-700 mt-2">Legal testing ensures the profile is documented correctly if it may be used later in court. Learn more about <Link to="/aabb-accredited-dna-testing-denver" className="text-blue-600 hover:underline">AABB partner-laboratory standards for legal DNA testing</Link>.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-10 px-6 bg-white border-t border-gray-200">
        <div className="max-w-4xl mx-auto text-center text-gray-700">
          <p>
            We also offer <Link to="/services/legal-paternity-testing" className="text-blue-600 hover:underline">legal paternity DNA testing</Link>, <Link to="/services/prenatal-paternity-testing" className="text-blue-600 hover:underline">prenatal paternity testing</Link>, and <Link to="/services/immigration-dna-testing" className="text-blue-600 hover:underline">immigration DNA testing</Link>. Learn about <Link to="/aabb-accredited-dna-testing-denver" className="text-blue-600 hover:underline">AABB partner-laboratory standards for legal DNA testing</Link> and our <Link to="/locations/denver" className="text-blue-600 hover:underline">Denver location</Link>.
          </p>
        </div>
      </section>
    </main>
