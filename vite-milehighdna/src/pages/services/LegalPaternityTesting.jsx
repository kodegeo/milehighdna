  ...
  return (
    <main>
      <Helmet>
        ...
        <meta
          name="description"
          content="Court-admissible legal paternity DNA testing in Denver. Chain of custody; analysis by an AABB accredited laboratory. Results in 3–5 days. Call (720) 900-9342 for same-day availability."
        />
        ...
        <meta
          ...
          content="Court-admissible legal paternity DNA testing with strict chain of custody. Serving Denver and Colorado with fast results through AABB accredited laboratory where applicable."
        />
        <meta
          property="og:image"
        ...
        <meta
          ...
          content="Fast, confidential legal paternity DNA testing accepted by courts and agencies. Coordinated with an AABB accredited laboratory."
        />
        <meta
          name="twitter:image"
          content="https://milehighdnatesting.com/images/banner-1200.png"
      ...
      <section className="bg-white py-2 px-6 text-center">
        <div className="max-w-4xl mx-auto space-y-3">
          ...
          <p className="text-gray-700">
            Our testing meets <Link to="/partner-laboratory-denver" className="text-blue-600 hover:underline">AABB accredited laboratory standards</Link>.
          </p>
        </div>
      </section>
      ...
      <section className="py-10 px-6 bg-blue-50 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-gray-700 mb-6">
            ...
            testing meets <Link to="/partner-laboratory-denver" className="text-blue-600 hover:underline">AABB accredited laboratory standards for legal DNA testing</Link> and is simple, fast, and fully court-admissible.
          </p>
      ...
      <section className="py-12 px-6 bg-gray-50 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-gray-700 mb-6">
            ...
            Our pricing includes professional collection, chain of custody, and AABB accredited laboratory analysis.
          </p>
      ...
      <ServiceOverview
        ...
        paragraphs={[
          ...
          "At Mile High DNA Testing, all samples are collected by trained professionals and processed by an AABB accredited laboratory. Our results are accepted for child custody, child support, birth certificate changes, inheritance cases, and immigration matters.",
