  ...
  return (
    <main>
      <Helmet>
        ...
        <meta
          name="description"
          content="Call (720) 900-9342 for same-day prenatal DNA testing. Safe, non-invasive paternity test from 7 weeks. AABB accredited laboratory results accepted for legal or peace-of-mind cases."
        />
      ...
      <section className="py-12 px-6 bg-gray-50 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-gray-700 mb-6">
            ...
            Our non-invasive prenatal DNA testing includes professional collection and AABB accredited laboratory analysis.
          </p>
