...
const PRENATAL_PATERNITY_FAQS = [
  {
    ...
    answerSchema:
      "Non-invasive prenatal paternity testing requires only a maternal blood draw and a cheek swab from the alleged father. The pregnancy is not disturbed during testing. Our prenatal paternity test is endorsed by the American Pregnancy Association and processed by an accredited partner laboratory in the United States.",
    answer: (
      <>
        <p>
        ...
        <p>
          Our prenatal paternity test is endorsed by the American Pregnancy Association and processed by an accredited partner laboratory in the United States.
        </p>
      </>
    ),
  },
  {
    ...
    answerSchema:
      "Non-invasive prenatal paternity testing is 99.9% accurate. Testing is conducted by the only accredited partner laboratory performing non-invasive prenatal paternity analysis in the United States. This accreditation confirms adherence to strict scientific validation standards. When collected under legal chain-of-custody procedures, prenatal results meet court admissibility requirements.",
    answer: (
      <>
        <p>Non-invasive prenatal paternity testing is 99.9% accurate.</p>
        <p>
          Testing is conducted by the only accredited partner laboratory performing non-invasive prenatal paternity analysis in the United States. This accreditation confirms adherence to strict scientific validation standards.
        </p>
  ...
  return (
    <main>
      <Helmet>
        ...
        <meta
          name="description"
          content="Call (720) 900-9342 for same-day prenatal DNA testing. Safe, non-invasive paternity test from 7 weeks. accredited partner laboratory results accepted for legal or peace-of-mind cases."
        />
      ...
      <section className="py-12 px-6 bg-gray-50 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-gray-700 mb-6">
            ...
            Our non-invasive prenatal DNA testing includes professional collection and accredited partner laboratory analysis.
          </p>
