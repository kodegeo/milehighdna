            ...
            <div className="bg-white rounded-xl p-6 border border-gray-200">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Samples are sent to an AABB-accredited partner laboratory for analysis. The lab analyzes the cell-free DNA from the mother's blood sample to determine paternity.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="bg-gray-50 rounded-xl p-6 border border-gray-200">
              ...
              <p className="text-gray-600">
                Prenatal paternity testing provides highly accurate results. The test analyzes cell-free DNA from the mother's blood sample, which contains genetic material from both parents. Results are processed at AABB-accredited partner laboratories using advanced DNA analysis methods.
              </p>
            </div>
          </div>
        </div>
