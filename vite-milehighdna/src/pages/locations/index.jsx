...
<section className="bg-gradient-to-br from-blue-600 to-blue-800 text-white py-20">
  ...
  <div className="max-w-3xl mx-auto px-4 text-center">
    ...
    <p className="text-lg mb-6 text-blue-100">
      Mile High DNA Testing proudly serves families, attorneys, and immigration clients across Colorado with fast, confidential DNA testing services. We partner with an AABB-accredited partner laboratory for legal and immigration DNA testing. We offer{" "}
