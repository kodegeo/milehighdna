...
const Boulder = () => {
  ...
  const cityImage = `/images/boulder-matthew-williams.jpg`;
  const photographer = "Matthew Williams";
  const [imageError, setImageError] = useState(false);
  const metaDescription = "Expert DNA testing in Boulder, Colorado. Court-required paternity, USCIS immigration, and relationship verification with accurate, fast results.";
  const canonical = canonicalUrl(citySlug);
  const neighborhoods = "Gunbarrel, North Boulder, South Boulder, University Hill, Mapleton Hill, Newlands, Table Mesa, and surrounding Boulder County communities";
