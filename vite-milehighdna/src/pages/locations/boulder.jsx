...
const Boulder = () => {
  return (
    <>
      <Helmet>
        <title>DNA Testing in Boulder, Colorado | Mile High DNA Testing</title>
        <meta name="description" content="Expert, AABB-accredited DNA testing in Boulder, Colorado. Court-required paternity, USCIS immigration, and relationship verification with accurate, fast results." />
        <link rel="canonical" href={canonicalUrl("boulder")} />
        <script type="application/ld+json">
          {JSON.stringify({
            "@context": "https://schema.org",
            "@type": "LocalBusiness",
            "name": "Mile High DNA Testing",
            "url": canonicalUrl("boulder"),
            "serviceArea": {
              "@type": "City",
              "name": "Boulder"
            },
            "description": "Expert, AABB-accredited DNA testing in Boulder, Colorado. Court-required paternity, USCIS immigration, and relationship verification with accurate, fast results."
          })}
        </script>
      </Helmet>
      <div className="max-w-3xl mx-auto py-10 px-4">
      <h1 className="text-4xl font-bold mb-6">DNA Testing in Boulder, Colorado</h1>
      
      <p className="text-lg mb-6">
        Mile High DNA Testing provides expert, confidential, and AABB-accredited DNA testing services to families, attorneys, and immigration professionals throughout <strong>Boulder, Colorado</strong>. From court-required paternity documentation to personal relationship verification and USCIS immigration cases, we deliver accurate, fast, and trustworthy results you can depend on.
      </p>

      <hr className="my-8 border-gray-300" />

      <h2 className="text-3xl font-bold mb-4">DNA Testing Services Available in Boulder</h2>
      ...
      <h2 className="text-3xl font-bold mb-4">Areas We Serve in Boulder</h2>
      
      <p className="mb-4">
        We proudly support residents across <strong>Boulder</strong> and nearby neighborhoods, including:
      </p>
      
      <p className="mb-6 font-semibold">
        Gunbarrel, North Boulder, South Boulder, University Hill, Mapleton Hill, Newlands, Table Mesa, and surrounding Boulder County communities
      </p>
      ...
      <h2 className="text-3xl font-bold mb-4">Why Choose Mile High DNA Testing in Boulder?</h2>
      ...
      <h2 className="text-3xl font-bold mb-4">FAQ for Boulder DNA Testing</h2>
      
      <div className="space-y-4 mb-6">
        <div>
          <p className="font-semibold mb-2">How fast can I get DNA results in Boulder?</p>
        ...
        <div>
          <p className="font-semibold mb-2">Do you offer mobile DNA testing in Boulder?</p>
      ...
      <h2 className="text-3xl font-bold mb-4">Schedule Your Appointment in Boulder</h2>
