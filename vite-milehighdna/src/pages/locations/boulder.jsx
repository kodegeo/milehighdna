...
const Boulder = () => {
  ...
  const metaDescription = "Expert, AABB-accredited DNA testing in Boulder, Colorado. Court-required paternity, USCIS immigration, and relationship verification with accurate, fast results.";
