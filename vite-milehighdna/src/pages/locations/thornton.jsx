...
const Thornton = () => {
  ...
  const metaDescription = "Comprehensive, AABB-certified DNA testing in Thornton, Colorado. Legal paternity, immigration documentation, and relationship testing with precise, confidential results.";
