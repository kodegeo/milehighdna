...
const Thornton = () => {
  const citySlug = "thornton";
  const cityName = "Thornton";
  const cityImage = `/images/thornton.jpg`;
  const photographer = null;
  const [imageError, setImageError] = useState(false);
  const metaDescription = "Comprehensive DNA testing in Thornton, Colorado. Legal paternity, immigration documentation, and relationship testing with precise, confidential results.";
  const canonical = canonicalUrl(citySlug);
  const neighborhoods = "Northglenn, Westminster, Brighton, Commerce City, Federal Heights, and surrounding Adams County communities";
