...
const Thornton = () => {
  return (
    <>
      <Helmet>
        <title>DNA Testing in Thornton, Colorado | Mile High DNA Testing</title>
        <meta name="description" content="Comprehensive, AABB-certified DNA testing in Thornton, Colorado. Legal paternity, immigration documentation, and relationship testing with precise, confidential results." />
        <link rel="canonical" href={canonicalUrl("thornton")} />
        <script type="application/ld+json">
          {JSON.stringify({
            "@context": "https://schema.org",
            "@type": "LocalBusiness",
            "name": "Mile High DNA Testing",
            "url": canonicalUrl("thornton"),
            "serviceArea": {
              "@type": "City",
              "name": "Thornton"
            },
            "description": "Comprehensive, AABB-certified DNA testing in Thornton, Colorado. Legal paternity, immigration documentation, and relationship testing with precise, confidential results."
          })}
        </script>
      </Helmet>
      <div className="max-w-3xl mx-auto py-10 px-4">
      <h1 className="text-4xl font-bold mb-6">DNA Testing in Thornton, Colorado</h1>
      
      <p className="text-lg mb-6">
        Mile High DNA Testing offers comprehensive, reliable, and AABB-certified DNA testing solutions for individuals, families, law firms, and immigration services across <strong>Thornton, Colorado</strong>. Whether you require legally binding results for court cases, personal relationship confirmation, or USCIS immigration documentation, our dedicated team delivers precise, timely, and confidential outcomes.
      </p>

      <hr className="my-8 border-gray-300" />

      <h2 className="text-3xl font-bold mb-4">DNA Testing Services Available in Thornton</h2>
      ...
      <h2 className="text-3xl font-bold mb-4">Areas We Serve in Thornton</h2>
      
      <p className="mb-4">
        We proudly support residents across <strong>Thornton</strong> and nearby neighborhoods, including:
      </p>
      
      <p className="mb-6 font-semibold">
        Northglenn, Westminster, Brighton, Commerce City, Federal Heights, and surrounding Adams County communities
      </p>
      ...
      <h2 className="text-3xl font-bold mb-4">Why Choose Mile High DNA Testing in Thornton?</h2>
      ...
      <h2 className="text-3xl font-bold mb-4">FAQ for Thornton DNA Testing</h2>
      
      <div className="space-y-4 mb-6">
        <div>
          <p className="font-semibold mb-2">How fast can I get DNA results in Thornton?</p>
        ...
        <div>
          <p className="font-semibold mb-2">Do you offer mobile DNA testing in Thornton?</p>
      ...
      <h2 className="text-3xl font-bold mb-4">Schedule Your Appointment in Thornton</h2>
