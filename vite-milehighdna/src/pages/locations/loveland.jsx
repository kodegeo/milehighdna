...
const Loveland = () => {
  return (
    <>
      <Helmet>
        <title>DNA Testing in Loveland, Colorado | Mile High DNA Testing</title>
        <meta name="description" content="Comprehensive, AABB-certified DNA testing in Loveland, Colorado. Legal paternity, immigration, and peace-of-mind testing with accurate, timely, and confidential results." />
        <link rel="canonical" href={canonicalUrl("loveland")} />
        <script type="application/ld+json">
          {JSON.stringify({
            "@context": "https://schema.org",
            "@type": "LocalBusiness",
            "name": "Mile High DNA Testing",
            "url": canonicalUrl("loveland"),
            "serviceArea": {
              "@type": "City",
              "name": "Loveland"
            },
            "description": "Comprehensive, AABB-certified DNA testing in Loveland, Colorado. Legal paternity, immigration, and peace-of-mind testing with accurate, timely, and confidential results."
          })}
        </script>
      </Helmet>
      <div className="max-w-3xl mx-auto py-10 px-4">
      <h1 className="text-4xl font-bold mb-6">DNA Testing in Loveland, Colorado</h1>
      
      <p className="text-lg mb-6">
        Mile High DNA Testing offers comprehensive, reliable, and AABB-certified DNA testing solutions for individuals, families, law firms, and immigration agencies in <strong>Loveland, Colorado</strong>. Whether you require legally binding results for court cases, personal peace-of-mind tests, or USCIS immigration verification, our dedicated team delivers accurate, timely, and confidential outcomes.
      </p>

      <hr className="my-8 border-gray-300" />

      <h2 className="text-3xl font-bold mb-4">DNA Testing Services Available in Loveland</h2>
      ...
      <h2 className="text-3xl font-bold mb-4">Areas We Serve in Loveland</h2>
      
      <p className="mb-4">
        We proudly support residents across <strong>Loveland</strong> and nearby neighborhoods, including:
      </p>
      ...
      <h2 className="text-3xl font-bold mb-4">Why Choose Mile High DNA Testing in Loveland?</h2>
      ...
      <h2 className="text-3xl font-bold mb-4">FAQ for Loveland DNA Testing</h2>
      
      <div className="space-y-4 mb-6">
        <div>
          <p className="font-semibold mb-2">How fast can I get DNA results in Loveland?</p>
        ...
        <div>
          <p className="font-semibold mb-2">Do you offer mobile DNA testing in Loveland?</p>
      ...
      <h2 className="text-3xl font-bold mb-4">Schedule Your Appointment in Loveland</h2>
