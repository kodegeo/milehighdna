...
const Loveland = () => {
  const citySlug = "loveland";
  const cityName = "Loveland";
  const cityImage = `/images/loveland.jpg`;
  const photographer = null;
  const [imageError, setImageError] = useState(false);
  const metaDescription = "Comprehensive DNA testing in Loveland, Colorado. Legal paternity, immigration, and peace-of-mind testing with accurate, timely, and confidential results.";
  const canonical = canonicalUrl(citySlug);
  const neighborhoods = "Berthoud, Johnstown, Windsor, Fort Collins, and surrounding Larimer County communities";
