...
const Loveland = () => {
  ...
  const metaDescription = "Comprehensive, AABB-certified DNA testing in Loveland, Colorado. Legal paternity, immigration, and peace-of-mind testing with accurate, timely, and confidential results.";
