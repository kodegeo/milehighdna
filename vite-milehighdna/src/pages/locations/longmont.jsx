...
const Longmont = () => {
  const citySlug = "longmont";
  const cityName = "Longmont";
  const cityImage = `/images/longmont.jpg`;
  const photographer = null;
  const [imageError, setImageError] = useState(false);
  const metaDescription = "Professional DNA testing in Longmont, Colorado. Legal paternity, immigration verification, and peace-of-mind testing with reliable, timely results.";
  const canonical = canonicalUrl(citySlug);
  const neighborhoods = "Niwot, Lyons, Firestone, Frederick, Mead, and surrounding Boulder County and Weld County communities";
