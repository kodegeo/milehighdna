...
const Longmont = () => {
  return (
    <>
      <Helmet>
        <title>DNA Testing in Longmont, Colorado | Mile High DNA Testing</title>
        <meta name="description" content="Professional, AABB-certified DNA testing in Longmont, Colorado. Legal paternity, immigration verification, and peace-of-mind testing with reliable, timely results." />
        <link rel="canonical" href={canonicalUrl("longmont")} />
        <script type="application/ld+json">
          {JSON.stringify({
            "@context": "https://schema.org",
            "@type": "LocalBusiness",
            "name": "Mile High DNA Testing",
            "url": canonicalUrl("longmont"),
            "serviceArea": {
              "@type": "City",
              "name": "Longmont"
            },
            "description": "Professional, AABB-certified DNA testing in Longmont, Colorado. Legal paternity, immigration verification, and peace-of-mind testing with reliable, timely results."
          })}
        </script>
      </Helmet>
      <div className="max-w-3xl mx-auto py-10 px-4">
      <h1 className="text-4xl font-bold mb-6">DNA Testing in Longmont, Colorado</h1>
      
      <p className="text-lg mb-6">
        Mile High DNA Testing delivers professional, accurate, and AABB-certified DNA analysis services to residents, law offices, and immigration agencies in <strong>Longmont, Colorado</strong>. Whether you need legally binding test results for court proceedings, personal peace-of-mind screenings, or USCIS immigration verification, our experienced team ensures reliable, timely, and confidential testing solutions.
      </p>

      <hr className="my-8 border-gray-300" />

      <h2 className="text-3xl font-bold mb-4">DNA Testing Services Available in Longmont</h2>
      ...
      <h2 className="text-3xl font-bold mb-4">Areas We Serve in Longmont</h2>
      
      <p className="mb-4">
        We proudly support residents across <strong>Longmont</strong> and nearby neighborhoods, including:
      </p>
      ...
      <h2 className="text-3xl font-bold mb-4">Why Choose Mile High DNA Testing in Longmont?</h2>
      ...
      <h2 className="text-3xl font-bold mb-4">FAQ for Longmont DNA Testing</h2>
      
      <div className="space-y-4 mb-6">
        <div>
          <p className="font-semibold mb-2">How fast can I get DNA results in Longmont?</p>
        ...
        <div>
          <p className="font-semibold mb-2">Do you offer mobile DNA testing in Longmont?</p>
      ...
      <h2 className="text-3xl font-bold mb-4">Schedule Your Appointment in Longmont</h2>
