...
const Longmont = () => {
  ...
  const metaDescription = "Professional, AABB-certified DNA testing in Longmont, Colorado. Legal paternity, immigration verification, and peace-of-mind testing with reliable, timely results.";
