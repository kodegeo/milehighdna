...
const ColoradoSprings = () => {
  const citySlug = "colorado-springs";
  const cityName = "Colorado Springs";
  const cityImage = `/images/colorado-springs-kevin-bree.jpg`;
  const photographer = "Kevin Bree";
  const [imageError, setImageError] = useState(false);
  const metaDescription = "Professional DNA testing in Colorado Springs, Colorado. Legal paternity, immigration verification, and peace-of-mind testing with reliable, timely results.";
  const canonical = canonicalUrl(citySlug);
  const neighborhoods = "Downtown, Old Colorado City, Briargate, Powers Corridor, Broadmoor, Manitou Springs, Fountain, and surrounding El Paso County communities";
