...
const ColoradoSprings = () => {
  ...
  const metaDescription = "Professional, AABB-certified DNA testing in Colorado Springs, Colorado. Legal paternity, immigration verification, and peace-of-mind testing with reliable, timely results.";
