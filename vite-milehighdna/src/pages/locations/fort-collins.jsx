...
const FortCollins = () => {
  const citySlug = "fort-collins";
  const cityName = "Fort Collins";
  const cityImage = `/images/fort-collins.jpg`;
  const photographer = null;
  const [imageError, setImageError] = useState(false);
  const metaDescription = "Trusted DNA testing in Fort Collins, Colorado. Court-admissible paternity, USCIS immigration, and relationship testing with precise, professional results.";
  const canonical = canonicalUrl(citySlug);
  const neighborhoods = "Old Town, Campus West, Harmony, Timnath, Laporte, Wellington, and surrounding Larimer County communities";
