...
const FortCollins = () => {
  return (
    <>
      <Helmet>
        <title>DNA Testing in Fort Collins, Colorado | Mile High DNA Testing</title>
        <meta name="description" content="Trusted, AABB-accredited DNA testing in Fort Collins, Colorado. Court-admissible paternity, USCIS immigration, and relationship testing with precise, professional results." />
        <link rel="canonical" href={canonicalUrl("fort-collins")} />
        <script type="application/ld+json">
          {JSON.stringify({
            "@context": "https://schema.org",
            "@type": "LocalBusiness",
            "name": "Mile High DNA Testing",
            "url": canonicalUrl("fort-collins"),
            "serviceArea": {
              "@type": "City",
              "name": "Fort Collins"
            },
            "description": "Trusted, AABB-accredited DNA testing in Fort Collins, Colorado. Court-admissible paternity, USCIS immigration, and relationship testing with precise, professional results."
          })}
        </script>
      </Helmet>
      <div className="max-w-3xl mx-auto py-10 px-4">
      <h1 className="text-4xl font-bold mb-6">DNA Testing in Fort Collins, Colorado</h1>
      
      <p className="text-lg mb-6">
        Mile High DNA Testing specializes in providing trusted, confidential, and AABB-accredited DNA testing services to families, legal professionals, and immigration services throughout <strong>Fort Collins, Colorado</strong>. From court-admissible paternity testing to personal relationship confirmation and USCIS immigration documentation, we ensure precise, fast, and professional results for every situation.
      </p>

      <hr className="my-8 border-gray-300" />

      <h2 className="text-3xl font-bold mb-4">DNA Testing Services Available in Fort Collins</h2>
      ...
      <h2 className="text-3xl font-bold mb-4">Areas We Serve in Fort Collins</h2>
      
      <p className="mb-4">
        We proudly support residents across <strong>Fort Collins</strong> and nearby neighborhoods, including:
      </p>
      
      <p className="mb-6 font-semibold">
        Old Town, Campus West, Harmony, Timnath, Laporte, Wellington, and surrounding Larimer County communities
      </p>
      ...
      <h2 className="text-3xl font-bold mb-4">Why Choose Mile High DNA Testing in Fort Collins?</h2>
      ...
      <h2 className="text-3xl font-bold mb-4">FAQ for Fort Collins DNA Testing</h2>
      
      <div className="space-y-4 mb-6">
        <div>
          <p className="font-semibold mb-2">How fast can I get DNA results in Fort Collins?</p>
        ...
        <div>
          <p className="font-semibold mb-2">Do you offer mobile DNA testing in Fort Collins?</p>
      ...
      <h2 className="text-3xl font-bold mb-4">Schedule Your Appointment in Fort Collins</h2>
