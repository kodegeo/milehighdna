...
const FortCollins = () => {
  ...
  const metaDescription = "Trusted, AABB-accredited DNA testing in Fort Collins, Colorado. Court-admissible paternity, USCIS immigration, and relationship testing with precise, professional results.";
