...
const Arvada = () => {
  ...
  const metaDescription = "Professional, AABB-certified DNA testing in Arvada, Colorado. Legal paternity, immigration, and relationship verification with reliable, timely, and confidential results.";
