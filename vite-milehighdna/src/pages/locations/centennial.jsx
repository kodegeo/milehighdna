...
const Centennial = () => {
  ...
  const metaDescription = "Comprehensive, AABB-certified DNA testing in Centennial, Colorado. Legal paternity, immigration documentation, and relationship testing with accurate, timely results.";
