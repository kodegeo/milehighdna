...
const Centennial = () => {
  return (
    <>
      <Helmet>
        <title>DNA Testing in Centennial, Colorado | Mile High DNA Testing</title>
        <meta name="description" content="Comprehensive, AABB-certified DNA testing in Centennial, Colorado. Legal paternity, immigration documentation, and relationship testing with accurate, timely results." />
        <link rel="canonical" href={canonicalUrl("centennial")} />
        <script type="application/ld+json">
          {JSON.stringify({
            "@context": "https://schema.org",
            "@type": "LocalBusiness",
            "name": "Mile High DNA Testing",
            "url": canonicalUrl("centennial"),
            "serviceArea": {
              "@type": "City",
              "name": "Centennial"
            },
            "description": "Comprehensive, AABB-certified DNA testing in Centennial, Colorado. Legal paternity, immigration documentation, and relationship testing with accurate, timely results."
          })}
        </script>
      </Helmet>
      <div className="max-w-3xl mx-auto py-10 px-4">
      <h1 className="text-4xl font-bold mb-6">DNA Testing in Centennial, Colorado</h1>
      
      <p className="text-lg mb-6">
        Mile High DNA Testing offers comprehensive, reliable, and AABB-certified DNA testing services to families, legal professionals, and immigration agencies serving <strong>Centennial, Colorado</strong>. Whether you require legally binding test results for court cases, personal relationship confirmation, or USCIS immigration documentation, our dedicated team ensures accurate, timely, and confidential outcomes.
      </p>

      <hr className="my-8 border-gray-300" />

      <h2 className="text-3xl font-bold mb-4">DNA Testing Services Available in Centennial</h2>
      ...
      <h2 className="text-3xl font-bold mb-4">Areas We Serve in Centennial</h2>
      
      <p className="mb-4">
        We proudly support residents across <strong>Centennial</strong> and nearby neighborhoods, including:
      </p>
      
      <p className="mb-6 font-semibold">
        Littleton, Greenwood Village, Parker, Highlands Ranch, Lone Tree, Castle Pines, Cherry Hills Village, and Arapahoe County communities
      </p>
      ...
      <h2 className="text-3xl font-bold mb-4">Why Choose Mile High DNA Testing in Centennial?</h2>
      ...
      <h2 className="text-3xl font-bold mb-4">FAQ for Centennial DNA Testing</h2>
      
      <div className="space-y-4 mb-6">
        <div>
          <p className="font-semibold mb-2">How fast can I get DNA results in Centennial?</p>
        ...
        <div>
          <p className="font-semibold mb-2">Do you offer mobile DNA testing in Centennial?</p>
      ...
      <h2 className="text-3xl font-bold mb-4">Schedule Your Appointment in Centennial</h2>
