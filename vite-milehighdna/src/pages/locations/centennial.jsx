...
const Centennial = () => {
  const citySlug = "centennial";
  const cityName = "Centennial";
  const cityImage = `/images/centennial-acton-crawford.jpg`;
  const photographer = "Acton Crawford";
  const [imageError, setImageError] = useState(false);
  const metaDescription = "Comprehensive DNA testing in Centennial, Colorado. Legal paternity, immigration documentation, and relationship testing with accurate, timely results.";
  const canonical = canonicalUrl(citySlug);
  const neighborhoods = "Littleton, Greenwood Village, Parker, Highlands Ranch, Lone Tree, Castle Pines, Cherry Hills Village, and Arapahoe County communities";
      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <section className="mb-16">
          ...
          <div className="space-y-4 max-w-3xl mx-auto">
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm hover:shadow-md transition-shadow">
              ...
              <p className="text-gray-600">Yes. Immigration relationship testing is coordinated to meet USCIS and embassy requirements, including processing by an AABB accredited laboratory when required for your case.</p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-16">
          ...
          <ul className="list-disc list-inside space-y-2 max-w-2xl mx-auto text-gray-700">
            <li><Link to="/guides/dna-test-while-pregnant" className="text-blue-600 underline hover:text-blue-700">DNA Testing While Pregnant</Link></li>
            <li><Link to="/guides/prenatal-paternity-test-accuracy" className="text-blue-600 underline hover:text-blue-700">Prenatal Paternity Test Accuracy</Link></li>
