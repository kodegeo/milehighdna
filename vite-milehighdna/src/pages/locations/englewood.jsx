...
const Englewood = () => {
  const citySlug = "englewood";
  const cityName = "Englewood";
  const cityImage = `/images/englewood-gennady-zakharin.jpg`;
  const photographer = "Gennady Zakharin";
  const [imageError, setImageError] = useState(false);
  const metaDescription = "Expert DNA testing in Englewood, Colorado. Court-admissible paternity, USCIS immigration, and peace-of-mind testing with precise, fast results.";
  const canonical = canonicalUrl(citySlug);
  const neighborhoods = "Sheridan, Littleton, Cherry Hills Village, Greenwood Village, South Broadway, Arapahoe County, and surrounding Denver metro communities";
      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <section className="mb-16">
          ...
          <ul className="list-disc list-inside space-y-2 max-w-2xl mx-auto text-gray-700">
            ...
            <li><Link to="/guides/how-accurate-is-dna-testing" className="text-blue-600 underline hover:text-blue-700">How Accurate Is DNA Testing</Link></li>
          </ul>
        </section>
