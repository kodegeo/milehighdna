...
const Englewood = () => {
  ...
  const metaDescription = "Expert, AABB-accredited DNA testing in Englewood, Colorado. Court-admissible paternity, USCIS immigration, and peace-of-mind testing with precise, fast results.";
