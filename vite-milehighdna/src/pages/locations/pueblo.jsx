...
const Pueblo = () => {
  const citySlug = "pueblo";
  const cityName = "Pueblo";
  const cityImage = `/images/pueblo.jpg`;
  const photographer = null;
  const [imageError, setImageError] = useState(false);
  const metaDescription = "Trusted DNA testing in Pueblo, Colorado. Court-admissible paternity, USCIS immigration, and relationship testing with precise, fast, professional results.";
  const canonical = canonicalUrl(citySlug);
  const neighborhoods = "Pueblo West, Belmont, East Side, South Side, North Side, and surrounding Pueblo County communities";
