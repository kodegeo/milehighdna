...
const Pueblo = () => {
  ...
  const metaDescription = "Trusted, AABB-accredited DNA testing in Pueblo, Colorado. Court-admissible paternity, USCIS immigration, and relationship testing with precise, fast, professional results.";
