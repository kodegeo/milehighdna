...
const Pueblo = () => {
  return (
    <>
      <Helmet>
        <title>DNA Testing in Pueblo, Colorado | Mile High DNA Testing</title>
        <meta name="description" content="Trusted, AABB-accredited DNA testing in Pueblo, Colorado. Court-admissible paternity, USCIS immigration, and relationship testing with precise, fast, professional results." />
        <link rel="canonical" href={canonicalUrl("pueblo")} />
        <script type="application/ld+json">
          {JSON.stringify({
            "@context": "https://schema.org",
            "@type": "LocalBusiness",
            "name": "Mile High DNA Testing",
            "url": canonicalUrl("pueblo"),
            "serviceArea": {
              "@type": "City",
              "name": "Pueblo"
            },
            "description": "Trusted, AABB-accredited DNA testing in Pueblo, Colorado. Court-admissible paternity, USCIS immigration, and relationship testing with precise, fast, professional results."
          })}
        </script>
      </Helmet>
      <div className="max-w-3xl mx-auto py-10 px-4">
      <h1 className="text-4xl font-bold mb-6">DNA Testing in Pueblo, Colorado</h1>
      
      <p className="text-lg mb-6">
        Mile High DNA Testing specializes in providing trusted, confidential, and AABB-accredited DNA testing services to individuals, families, legal professionals, and immigration services throughout <strong>Pueblo, Colorado</strong>. From court-admissible paternity testing to personal relationship confirmation and USCIS immigration documentation, we ensure precise, fast, and professional results for every client.
      </p>

      <hr className="my-8 border-gray-300" />

      <h2 className="text-3xl font-bold mb-4">DNA Testing Services Available in Pueblo</h2>
      ...
      <h2 className="text-3xl font-bold mb-4">Areas We Serve in Pueblo</h2>
      
      <p className="mb-4">
        We proudly support residents across <strong>Pueblo</strong> and nearby neighborhoods, including:
      </p>
      ...
      <h2 className="text-3xl font-bold mb-4">Why Choose Mile High DNA Testing in Pueblo?</h2>
      ...
      <h2 className="text-3xl font-bold mb-4">FAQ for Pueblo DNA Testing</h2>
      
      <div className="space-y-4 mb-6">
        <div>
          <p className="font-semibold mb-2">How fast can I get DNA results in Pueblo?</p>
        ...
        <div>
          <p className="font-semibold mb-2">Do you offer mobile DNA testing in Pueblo?</p>
      ...
      <h2 className="text-3xl font-bold mb-4">Schedule Your Appointment in Pueblo</h2>
