...
const Littleton = () => {
  ...
  const metaDescription = "Precise, confidential DNA testing in Littleton, Colorado. AABB-accredited legal paternity, immigration, and relationship testing with professional results you can trust.";
