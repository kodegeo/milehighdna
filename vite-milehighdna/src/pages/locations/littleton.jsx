...
const Littleton = () => {
  return (
    <>
      <Helmet>
        <title>DNA Testing in Littleton, Colorado | Mile High DNA Testing</title>
        <meta name="description" content="Precise, confidential DNA testing in Littleton, Colorado. AABB-accredited legal paternity, immigration, and relationship testing with professional results you can trust." />
        <link rel="canonical" href={canonicalUrl("littleton")} />
        <script type="application/ld+json">
          {JSON.stringify({
            "@context": "https://schema.org",
            "@type": "LocalBusiness",
            "name": "Mile High DNA Testing",
            "url": canonicalUrl("littleton"),
            "serviceArea": {
              "@type": "City",
              "name": "Littleton"
            },
            "description": "Precise, confidential DNA testing in Littleton, Colorado. AABB-accredited legal paternity, immigration, and relationship testing with professional results you can trust."
          })}
        </script>
      </Helmet>
      <div className="max-w-3xl mx-auto py-10 px-4">
      <h1 className="text-4xl font-bold mb-6">DNA Testing in Littleton, Colorado</h1>
      
      <p className="text-lg mb-6">
        Mile High DNA Testing specializes in providing precise, confidential, and AABB-accredited DNA testing services to residents, attorneys, and immigration professionals in <strong>Littleton, Colorado</strong>. From court-required paternity documentation to personal relationship verification and USCIS immigration cases, we deliver accurate, fast, and professional results you can trust.
      </p>

      <hr className="my-8 border-gray-300" />

      <h2 className="text-3xl font-bold mb-4">DNA Testing Services Available in Littleton</h2>
      ...
      <h2 className="text-3xl font-bold mb-4">Areas We Serve in Littleton</h2>
      
      <p className="mb-4">
        We proudly support residents across <strong>Littleton</strong> and nearby neighborhoods, including:
      </p>
      ...
      <h2 className="text-3xl font-bold mb-4">Why Choose Mile High DNA Testing in Littleton?</h2>
      ...
      <h2 className="text-3xl font-bold mb-4">FAQ for Littleton DNA Testing</h2>
      
      <div className="space-y-4 mb-6">
        <div>
          <p className="font-semibold mb-2">How fast can I get DNA results in Littleton?</p>
        ...
        <div>
          <p className="font-semibold mb-2">Do you offer mobile DNA testing in Littleton?</p>
      ...
      <h2 className="text-3xl font-bold mb-4">Schedule Your Appointment in Littleton</h2>
