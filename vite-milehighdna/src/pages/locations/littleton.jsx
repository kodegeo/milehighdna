...
const Littleton = () => {
  const citySlug = "littleton";
  const cityName = "Littleton";
  const cityImage = `/images/littleton.jpg`;
  const photographer = null;
  const [imageError, setImageError] = useState(false);
  const metaDescription = "Precise, confidential DNA testing in Littleton, Colorado. Court-admissible legal paternity, immigration, and relationship testing with professional results you can trust.";
  const canonical = canonicalUrl(citySlug);
  const neighborhoods = "Highlands Ranch, Ken Caryl, Columbine, Chatfield, Roxborough Park, Bow Mar, South Platte, Centennial, and Englewood";
      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <section className="mb-16">
          ...
          <ul className="list-disc list-inside space-y-2 max-w-2xl mx-auto text-gray-700">
            <li><Link to="/guides/grandparent-dna-testing-explained" className="text-blue-600 underline hover:text-blue-700">Grandparent DNA Testing Explained</Link></li>
            <li><Link to="/guides/siblingship-dna-testing-explained" className="text-blue-600 underline hover:text-blue-700">Siblingship DNA Testing Explained</Link></li>
