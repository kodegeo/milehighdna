...
const Westminster = () => {
  ...
  const metaDescription = "Trusted, AABB-accredited DNA testing in Westminster, Colorado. Court-admissible paternity, USCIS immigration, and peace-of-mind testing with accurate, fast results.";
