...
const Westminster = () => {
  return (
    <>
      <Helmet>
        <title>DNA Testing in Westminster, Colorado | Mile High DNA Testing</title>
        <meta name="description" content="Trusted, AABB-accredited DNA testing in Westminster, Colorado. Court-admissible paternity, USCIS immigration, and peace-of-mind testing with accurate, fast results." />
        <link rel="canonical" href={canonicalUrl("westminster")} />
        <script type="application/ld+json">
          {JSON.stringify({
            "@context": "https://schema.org",
            "@type": "LocalBusiness",
            "name": "Mile High DNA Testing",
            "url": canonicalUrl("westminster"),
            "serviceArea": {
              "@type": "City",
              "name": "Westminster"
            },
            "description": "Trusted, AABB-accredited DNA testing in Westminster, Colorado. Court-admissible paternity, USCIS immigration, and peace-of-mind testing with accurate, fast results."
          })}
        </script>
      </Helmet>
      <div className="max-w-3xl mx-auto py-10 px-4">
      <h1 className="text-4xl font-bold mb-6">DNA Testing in Westminster, Colorado</h1>
      
      <p className="text-lg mb-6">
        Mile High DNA Testing specializes in providing trusted, confidential, and AABB-accredited DNA testing services to families, legal professionals, and immigration agencies in <strong>Westminster, Colorado</strong>. From court-admissible paternity documentation to personal peace-of-mind tests and USCIS immigration verification, we ensure accurate, fast, and professional results for every client.
      </p>

      <hr className="my-8 border-gray-300" />

      <h2 className="text-3xl font-bold mb-4">DNA Testing Services Available in Westminster</h2>
      ...
      <h2 className="text-3xl font-bold mb-4">Areas We Serve in Westminster</h2>
      
      <p className="mb-4">
        We proudly support residents across <strong>Westminster</strong> and nearby neighborhoods, including:
      </p>
      ...
      <h2 className="text-3xl font-bold mb-4">Why Choose Mile High DNA Testing in Westminster?</h2>
      ...
      <h2 className="text-3xl font-bold mb-4">FAQ for Westminster DNA Testing</h2>
      
      <div className="space-y-4 mb-6">
        <div>
          <p className="font-semibold mb-2">How fast can I get DNA results in Westminster?</p>
        ...
        <div>
          <p className="font-semibold mb-2">Do you offer mobile DNA testing in Westminster?</p>
      ...
      <h2 className="text-3xl font-bold mb-4">Schedule Your Appointment in Westminster</h2>
