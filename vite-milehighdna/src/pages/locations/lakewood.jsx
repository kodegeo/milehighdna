...
const Lakewood = () => {
  ...
  const metaDescription = "Trusted DNA testing in Lakewood, Colorado. Legal paternity, immigration, and peace-of-mind testing with court-admissible results and fast processing.";
