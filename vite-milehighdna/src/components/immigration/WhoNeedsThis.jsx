      ...
      <section className="bg-white py-16 px-6 md:px-16 lg:px-24">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="text-lg text-gray-600 mb-8">
            Mile High DNA Testing coordinates USCIS-recognized relationship testing when directed by an AABB accredited laboratory we partner with. Immigration DNA testing is typically requested when documentation is insufficient to establish a biological relationship — USCIS, embassies, or consulates will specify if a DNA test is required for your case. Mile High DNA Testing cannot initiate immigration cases independently.
          </p>
