const Steps = () => {
    const steps = [
      ...
      },
      {
        ...
        description:
          'After submission, UFC (our AABB-accredited partner laboratory) will provide custom pricing for your case, required forms and invoice, and payment options such as credit cards or money orders.',
      },
      {
        number: 3,
      ...
      },
      {
        ...
        description:
          'Testing is performed by UFC, an AABB-accredited partner laboratory approved for USCIS cases. All testing follows strict chain-of-custody procedures for legal admissibility.',
      },
      {
        number: 5,
