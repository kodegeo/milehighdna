      ...
      <section className="bg-white py-12 md:py-16 px-6 md:px-12 lg:px-16">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-base md:text-lg text-gray-600 mb-8 leading-relaxed">
            ...
            {' '}and CAP-certified laboratory, coordinates <Link to="/services/immigration-dna-testing" className="text-blue-600 hover:text-blue-800 underline">immigration DNA testing</Link> for visa, passport, and citizenship cases when directed by the partner laboratory. Immigration DNA cases must be initiated by the partner laboratory — we provide local U.S. sample collection from our <Link to="/locations/denver" className="text-blue-600 hover:text-blue-800 underline">Denver</Link> office and international logistics coordination to ensure timely delivery of official results to{' '}
          ...
          <div className="grid gap-6 md:grid-cols-2 text-left">
            <div className="p-6 bg-white border border-gray-200 rounded-xl shadow-sm hover:shadow-md transition">
              ...
              <p className="text-base text-gray-600 leading-relaxed">
                ...
                <a href="https://www.ufclab.com/lab-services/immigration" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800 underline">AABB-accredited</a>
                {' '}lab partner when your case is initiated and directed by the partner laboratory. Learn more about <Link to="/partner-laboratory-denver" className="text-blue-600 hover:text-blue-800 underline">AABB accredited laboratory standards for legal and immigration testing</Link> and U.S. Department of State requirements.
              </p>
            </div>
            <div className="p-6 bg-white border border-gray-200 rounded-xl shadow-sm hover:shadow-md transition">
