      ...
      <section className="bg-[#F5F7FA] py-12 md:py-16 px-6 md:px-12 lg:px-16">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-base md:text-lg text-gray-600 mb-10 leading-relaxed">
            All immigration DNA testing fees are case-specific and not posted online. Immigration DNA cases must be initiated by an AABB accredited laboratory we partner with through the referral form and cannot be started directly through our website. Our team can guide you through next steps once your case is opened by the partner laboratory.
          </p>
          ...
          <p className="text-base text-gray-600 mt-6 leading-relaxed">
            Pricing varies by case, country, and number of participants. Immigration DNA testing is initiated by the partner laboratory through the referral form — complete the form so your case can be opened and directed appropriately.
          </p>
        </div>
      </section>
    );
