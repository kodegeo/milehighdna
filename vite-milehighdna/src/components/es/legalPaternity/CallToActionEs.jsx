    ...
    <section className="bg-[#2C6FA6] text-white py-16 px-6 md:px-12 text-center">
      <div className="max-w-3xl mx-auto">
        <h2 className="text-2xl md:text-4xl font-bold mb-4">
          {heading || "Programe su Consulta Gratuita Hoy"}
        </h2>
        <p className="text-lg mb-8">
          {subtext ||
            "Hable con un especialista para conocer más sobre nuestros servicios de pruebas de ADN, plazos y opciones legales. Nuestras consultas de 30 minutos son gratuitas y confidenciales."}
        </p>
        <a
          href={buttonLink || "https://calendly.com/milehighdnatesting/consulta-gratuita"}
          target="_blank"
