    ...
    const benefits = [
      {
        ...
        description:
          'Colaboramos con laboratorios acreditados por la AABB para pruebas legales y de inmigración, lo que ayuda a garantizar precisión científica y validez legal cuando corresponde.',
      },
      {
