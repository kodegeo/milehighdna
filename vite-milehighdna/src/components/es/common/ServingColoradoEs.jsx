    ...
    <section className="bg-white w-full">
      <div className="max-w-4xl mx-auto text-center py-16 px-6 md:px-12">
        ...
        <div className="text-[#2C6FA6] text-lg font-semibold space-y-2">
            ...
            <a 
              ...
              onClick={() => {
                window.dataLayer?.push({
                  event: "phone_click",
                  phone_location: "ServingColoradoEs - Common Component"
                });
              }}
          ...
          <p>Horas de operación: Lunes–Viernes: 9am–6pm | Sábado & Domingo: 9am–5pm <br />
           Todas las horas de operación con cita previa</p>
        </div>
      </div>
    </section>
  );
