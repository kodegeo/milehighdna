    ...
    const reasons = [
      {
        ...
        description:
          'Colaboramos con laboratorios acreditados por la AABB para pruebas legales y de inmigración, lo que ayuda a garantizar cumplimiento legal y precisión cuando corresponde.',
      },
      {
