    ...
    <section className="bg-white py-16 px-6 md:px-16 lg:px-24">
      <div className="max-w-5xl mx-auto text-center">
        ...
        <p className="text-lg text-gray-600 mb-8">
          ...
          The test is risk-free and provides over 99.9% accurate results for peace of mind or legal planning. For court or immigration use, analysis is performed by an AABB accredited laboratory when applicable—trusted by families across <Link to="/locations/denver" className="text-blue-600 underline">Denver</Link>, Aurora, Lakewood, and throughout Colorado.
        </p>
