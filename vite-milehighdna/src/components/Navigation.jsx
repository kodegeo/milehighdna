      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex md:items-center md:space-x-8">
            ...
            {/* AABB standards & partner laboratories */}
        ...
        {isMenuOpen && (
          <div className="md:hidden px-4 pb-4 max-h-[80vh] overflow-y-auto">
            ...
            <Link to="/aabb-accredited-dna-testing-denver" className="block py-2 text-gray-700" onClick={() => setIsMenuOpen(false)}>AABB & partner labs</Link>
