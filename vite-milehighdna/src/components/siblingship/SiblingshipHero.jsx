      ...
      <section className="bg-gradient-to-r from-white to-blue-50 py-12 px-6 md:px-16 lg:px-24">
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center">
          ...
          <div className="lg:w-1/2 mb-10 lg:mb-0">
            ...
            Get a court-admissible DNA test between siblings in Denver, Aurora, and Lakewood. Confirm full or half-sibling relationships with accredited partner laboratory results — legal and immigration-compliant.
            </p>
