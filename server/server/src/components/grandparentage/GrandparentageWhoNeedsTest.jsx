      ...
      <section className="bg-blue-50 py-16 px-6 md:px-16 lg:px-24">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="text-lg text-gray-600 mb-8">
            This test is ideal for situations where a biological parent is not available for testing, but
            you still need to establish a genetic relationship through the grandparent(s).
          </p>
