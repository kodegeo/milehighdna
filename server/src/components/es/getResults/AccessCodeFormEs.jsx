...
const AccessCodeFormEs = ({ onSubmit, label = "Código de Acceso", buttonText = "Enviar" }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!trimmedCode) {
      setError(`Por favor ingrese su ${label.toLowerCase()}.`);
      return;
    }
...
export default AccessCodeFormEs; 