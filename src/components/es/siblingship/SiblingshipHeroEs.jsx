        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center">
          ...
          <div className="lg:w-1/2 mb-10 lg:mb-0">
            <h1 className="text-4xl md:text-5xl font-bold text-gray-800 mb-4">
              Prueba de ADN de Hermanos con Confianza Legal
            </h1>
            <p className="text-lg text-gray-600 mb-6">
              Ya sea que esté confirmando una relación de hermanos completos o medios hermanos — para inmigración, 
              propósitos legales o tranquilidad personal — hacemos el proceso rápido, confidencial y preciso.
            </p>
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <a href="https://calendly.com/milehighdnatesting-info/30min" className="text-blue-600 font-semibold px-6 py-3 rounded-xl border border-blue-600 hover:bg-blue-50 transition">
                Hablar con un Especialista en ADN
              </a>
            </div>
          </div>
