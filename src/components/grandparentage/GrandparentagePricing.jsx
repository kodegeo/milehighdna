        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid gap-6 md:grid-cols-2">
            ...
            <div className="bg-white rounded-xl shadow-md border-l-4 border-blue-600 p-6">
              ...
              <p className="text-gray-600 mb-4">Includes a Non Legal DNA test for one grandparent and one child. Recommended for cases where court verification is required.</p>
