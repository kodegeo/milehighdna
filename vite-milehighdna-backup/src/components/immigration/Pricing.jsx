      ...
      <section className="bg-blue-50 py-16 px-6 md:px-16 lg:px-24">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl font-bold text-gray-800 mb-6">
            Transparent Pricing for Immigration DNA Testing
          </h2>
          ...
          <div className="bg-white rounded-xl shadow-lg border-t-4 border-blue-600 p-8 max-w-xl mx-auto">
            <h3 className="text-2xl font-bold text-gray-800 mb-4">Starting at $345</h3>
          ...
          <p className="text-sm text-gray-500 mt-6">
            *Pricing may vary depending on the number of participants and international coordination requirements.
          </p>
        </div>
      </section>
    );
